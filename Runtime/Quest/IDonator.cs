...
namespace giorgiokalmund.Dora
{
    ...
    public interface IQuickDonator<TDonation, VTarget> : IQuickDonator where VTarget : IDonator<TDonation>
    {
        ...
        bool IQuickDonator.QuickDonate()
        {
            ...
            DoraLogger.LogWarning($"Quick donation to {GetType().Name} failed. Please ensure that the quick donation interface is set up correctly: 'IQuickDonator<{typeof(TDonation).Name},{GetType().Name}>'");
            return false;
        }
    }
